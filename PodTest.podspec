...
Pod::Spec.new do |s|
  ...
  s.description  = "Test description a little longer than summary"
  ...
  # Or just: s.author    = "youj"
  # s.authors            = { "youj" => "282295491@11.com" }
  # s.social_media_url   = "http://twitter.com/youj"
